...
extension CardTemplate {
    ...
    static let defaultSeeds: [CardTemplateSeed] = [
        ...
        CardTemplateSeed(bankName: "東亞銀行", type: "UDC银联信用卡", colors: ["0F0F0F", "C0C0C0"], region: .cn, specialRate: [ : ], paymentMethodRates: [.qrCode : 1200], rewardType: .points, pointProgramKey: CardTemplateSeed.pointTemplateKey(bankName: "BEA HK", pointName: "Point", currencyCode: .hk), defaultRate: 100, foreignCurrencyRate: 100, categoryCaps: [: ], paymentCaps: [.qrCode: 100000], capPeriod: .monthly, pictureURL: ""), //need to change
