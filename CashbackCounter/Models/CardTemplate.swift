...
extension CardTemplate {
    ...
    static let defaultSeeds: [CardTemplateSeed] = [
        ...
        CardTemplateSeed(bankName: "AMEX HK", type: "Explorer", colors: ["0C1C26", "4B6E7D"], region: .hk, specialRate: [ : ], defaultRate: 1.6, foreignCurrencyRate: 5.9, pictureURL: "https://github.com/HarukaKinen/Cardentify/blob/main/Cards/American%20Express/American%20Express%20Explorer(TM)%20Credit%20Card.png?raw=true"),
        ...
        CardTemplateSeed(bankName: "工銀亞洲", type: "粵港澳灣區信用卡", colors: ["0F0F0F", "C0C0C0"], region: .cn, specialRate: [ : ], defaultRate: 1.5, foreignCurrencyRate: 1.5, categoryCaps: [: ], pictureURL: "icbcasiagba"),
