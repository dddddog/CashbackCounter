...
extension CardTemplate {
    ...
    static let defaultSeeds: [CardTemplateSeed] = [
        ...
        CardTemplateSeed(bankName: "AMEX US", type: "Bevy", colors: ["001C3D", "00A9E0"], region: .us, specialRate: [ .dining: 200, .other: 400, .grocery: 200], rewardType: .points, pointProgramKey: CardTemplateSeed.pointTemplateKey(bankName: "Marriott", pointName: "Point", currencyCode: .us), defaultRate: 200, foreignCurrencyRate: 200, pictureURL: ""),
        ...
        CardTemplateSeed(bankName: "AMEX US", type: "Surpass", colors: ["161D3A", "5A97D1"], region: .us, specialRate: [.grocery: 300, .dining: 300, .other: 900], rewardType: .points, pointProgramKey: CardTemplateSeed.pointTemplateKey(bankName: "Hilton", pointName: "Point", currencyCode: .us), defaultRate: 300, foreignCurrencyRate: 300, pictureURL: "amexusaspire"),
        ...
        CardTemplateSeed(bankName: "東亞銀行", type: "UDC银联信用卡", colors: ["0F0F0F", "C0C0C0"], region: .cn, specialRate: [ : ], paymentMethodRates: [.pulse : 1200, .online : 1100], rewardType: .points, pointProgramKey: CardTemplateSeed.pointTemplateKey(bankName: "BEA HK", pointName: "Point", currencyCode: .hk), defaultRate: 100, foreignCurrencyRate: 100, categoryCaps: [: ], paymentCaps: [.pulse: 100000, .online: 100000], capPeriod: .monthly, pictureURL: ""), //need to change
        CardTemplateSeed(bankName: "東亞銀行", type: "Wold Mastercard", colors: ["0F0F0F", "C0C0C0"], region: .hk, specialRate: [ : ],  rewardType: .points, pointProgramKey: CardTemplateSeed.pointTemplateKey(bankName: "BEA HK", pointName: "Point", currencyCode: .hk), defaultRate: 100, foreignCurrencyRate: 1150, foreignBaseCap: 115000, capPeriod: .monthly, pictureURL: ""), //need to change
        CardTemplateSeed(bankName: "建行亞洲", type: "Travo", colors: ["002B5C", "001A26"], region: .hk, specialRate: [ : ], paymentMethodRates: [ : ], rewardType: .points, pointProgramKey: CardTemplateSeed.pointTemplateKey(bankName: "CCB HK", pointName: "Point", currencyCode: .hk), defaultRate: 100, foreignCurrencyRate: 1000, foreignBaseCap: 225000, categoryCaps: [: ], paymentCaps: [: ], capPeriod: .yearly, pictureURL: "ccbtravo"), //need to change
        CardTemplateSeed(bankName: "建行亞洲", type: "eye", colors: ["002B5C", "001A26"], region: .hk, specialRate: [ .dining: 400 ], paymentMethodRates: [ : ], rewardType: .points, pointProgramKey: CardTemplateSeed.pointTemplateKey(bankName: "CCB HK", pointName: "Point", currencyCode: .hk), defaultRate: 100, foreignCurrencyRate: 100, categoryCaps: [.dining: 300000], paymentCaps: [: ], capPeriod: .yearly, pictureURL: "ccbeye"), //need to change
